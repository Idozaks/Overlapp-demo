...
const PersonOnline: FC = () => {
  ...
  const mockOnlineUsers: OnlineUser[] = [
    ...
    },
    {
      ...
      interests: ["Content Creation", "Digital Marketing", "Education", "Podcasting"],
  ...
  const displayedUsers = filterUsers(onlineUsers?.users || mockOnlineUsers, searchQuery);
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mb-6">
          Discover people active on websites and platforms with similar interests
        </p>
